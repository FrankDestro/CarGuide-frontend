import bookIcon from "../../assets/img/logobook2.png";
  ...
  return (
    <div >
      ...
      <footer className="bg-black dark:bg-gray-900">
        ...
        <footer className="bg-zinc-50 text-center text-surface dark:bg-neutral-900 dark:text-white">
            ...
            <form>
              <div className="gird-cols-1 grid items-center justify-center gap-4 md:grid-cols-3">
                ...
                <div className="mb-6 md:me-auto">
                  <button
                    type="button"
                    className="inline-block rounded bg-warning px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-black shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"

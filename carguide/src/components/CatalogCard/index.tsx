...
function CatalogCard({ vehicle }: Props) {
  return (
    <div>
      <div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-gray shadow-md">
        <a
          ...
          href={`/productdetails/${vehicle.id}`}
        >
          <img
        ...
        <div className="mt-4 px-3 pb-4">
          <Link to={`/productdetails/${vehicle.id}`}>
          ...
          <div className="mt-3 mb-4 flex flex-col  justify-between">
            <p>
              <span className="text-3xl font-bold text-black-900">
                R$ {vehicle.valueAmount},00
              </span>
              <span className="text-sm text-slate-900 line-through">
                R$ {vehicle.valueAmount}
              </span>
            </p>
            <div className="flex items-center mt-2">
              ...
              <span className="mr-2 ml-3 rounded bg-blue-500 px-2.5 py-0.5 text-xs font-semibold">
                5.0
              </span>
            </div>
            <div>
